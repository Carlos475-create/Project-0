...
select 
"Name" as "Track_Title", "Milliseconds" 
from "Track" 
where 
"Milliseconds" > 300000;
...
select 
"FirstName" as "Name",
"Email" as "Email_Address","Country" 
from 
"Customer"  
where 
"Country" = 'Brazil';
...
"Name" as "Track_Name", 	
"UnitPrice",
"Milliseconds" as "Duration_Miliseconds"
from
"Track" 
where 
"UnitPrice" > 1
...
select 
"FirstName" , "SupportRepId" , "CustomerId" , "Country" 
from 
"Customer" 
where 
"Country" ='USA'
...
"Track" 
where 
"Milliseconds" >250000 and "MediaTypeId" <=2;
